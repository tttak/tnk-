// NN評価関数の学習クラステンプレートのFeatureTransformer用特殊化

#ifndef _NN_TRAINER_FEATURE_TRANSFORMER_H_
#define _NN_TRAINER_FEATURE_TRANSFORMER_H_
...
#include "../nn_feature_transformer.h"
#include "trainer.h"
